...
keyboard.col_pins = (board.GP7, board.GP8, board.GP9, board.GP10, board.GP11, board.GP12, board.GP13, board.GP14, board.GP15, board.GP16, board.GP17, board.GP18, board.GP19, board.GP20, board.GP21)
...
encoder_handler.pins = ((board.GP22, board.GP23, None), (board.GP24, board.GP25, board.GP26))
encoder_handler.map = [((KC.BRIU, KC.BRID, KC.NO), (KC.VOLU, KC.VOLD, KC.MUTE))]
